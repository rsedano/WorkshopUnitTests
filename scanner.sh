rm -rf coverage
dotnet /Users/rodrigo.sedano/Desktop/SonarScanner/SonarScanner.MSBuild.dll begin /k:"WorkshopUnitTests" /o:"rsedano" /d:sonar.login="c61f7eda888900ac689ffc04011dc5a1e163bbbd" /d:sonar.coverageReportPaths=SonarQube.xml
